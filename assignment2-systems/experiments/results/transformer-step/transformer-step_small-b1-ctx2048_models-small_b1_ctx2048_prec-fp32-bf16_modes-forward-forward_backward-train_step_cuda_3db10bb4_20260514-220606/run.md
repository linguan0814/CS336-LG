...
- Run ID: `transformer-step_small-b1-ctx2048_models-small_b1_ctx2048_prec-fp32-bf16_modes-forward-forward_backward-train_step_cuda_3db10bb4_20260514-220606`
- Git commit: `3db10bb4`
...
| `run_id` | `transformer-step_small-b1-ctx2048_models-small_b1_ctx2048_prec-fp32-bf16_modes-forward-forward_backward-train_step_cuda_3db10bb4_20260514-220606` |
| `run_label` | `small-b1-ctx2048` |
| `timing_steps` | `4` |
| `vocab_size` | `10000` |
| `warmup_steps` | `2` |
