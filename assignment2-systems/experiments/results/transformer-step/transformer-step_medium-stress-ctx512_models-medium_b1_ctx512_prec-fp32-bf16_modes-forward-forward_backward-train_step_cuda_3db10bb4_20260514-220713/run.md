...
- Run ID: `transformer-step_medium-stress-ctx512_models-medium_b1_ctx512_prec-fp32-bf16_modes-forward-forward_backward-train_step_cuda_3db10bb4_20260514-220713`
- Git commit: `3db10bb4`
...
| `run_id` | `transformer-step_medium-stress-ctx512_models-medium_b1_ctx512_prec-fp32-bf16_modes-forward-forward_backward-train_step_cuda_3db10bb4_20260514-220713` |
| `run_label` | `medium-stress-ctx512` |
| `timing_steps` | `2` |
| `vocab_size` | `10000` |
| `warmup_steps` | `1` |
