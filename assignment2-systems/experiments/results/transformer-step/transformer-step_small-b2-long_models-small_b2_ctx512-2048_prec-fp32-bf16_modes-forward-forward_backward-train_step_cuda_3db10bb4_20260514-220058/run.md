...
- Run ID: `transformer-step_small-b2-long_models-small_b2_ctx512-2048_prec-fp32-bf16_modes-forward-forward_backward-train_step_cuda_3db10bb4_20260514-220058`
- Git commit: `3db10bb4`
...
| `run_id` | `transformer-step_small-b2-long_models-small_b2_ctx512-2048_prec-fp32-bf16_modes-forward-forward_backward-train_step_cuda_3db10bb4_20260514-220058` |
| `run_label` | `small-b2-long` |
| `timing_steps` | `8` |
| `vocab_size` | `10000` |
| `warmup_steps` | `3` |
